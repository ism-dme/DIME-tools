    ...
    <desc>
      ...
      <p>
        ...
        <ul>
          ...
          <li>P_LANGUAGE<p>Language for displaying instrument names. Possible values: 'IT' (default), 'EN', 'DE'.</p></li>
        </ul>
      </p>
      <p>
        <b>Notes: </b>
