...
<stylesheet version="3.0" xmlns:saxon="http://saxon.sf.net/" xmlns="http://www.w3.org/1999/XSL/Transform">
	...
	<output encoding="UTF-8" indent="yes" method="xml" saxon:indent-spaces="2" use-character-maps="entities"/>
