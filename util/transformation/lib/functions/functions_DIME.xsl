...
-->
  ...
  <function name="dme:add-mei-attributes" as="element()?" xmlns:dme="http://www.mozarteum.at/ns/dme">
    <param name="elements" as="element()*"/>
    <param name="attrNames" as="xs:QName*"/>
    <param name="attrValues" as="xs:anyAtomicType*"/>
