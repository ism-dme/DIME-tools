...
<stylesheet exclude-result-prefixes="xs xd mei dme" version="3.0" xmlns="http://www.w3.org/1999/XSL/Transform" xmlns:dme="http://www.mozarteum.at/ns/dme" xmlns:mei="http://www.music-encoding.org/ns/mei" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xpath-default-namespace="http://www.music-encoding.org/ns/mei">
  ...
  <doc scope="stylesheet" xmlns="http://www.oxygenxml.com/ns/doc/xsl">
    <desc>
      ...
      <pre> </pre>
      <p>
        <b>Usage: </b> The tool expects parameter <xd:i>parts</xd:i> which can be either passed via CLI or utilizing GUI implemented in oXygen. To access the GUI, open the file **/options/options.xml in Author mode. The syntax of <xd:i>parts</xd:i> is as following |&lt;staffNumber>[.&lt;layerNumber>]?|. For instance, |2.2| refers to second staff, second layer. Note that the layer-part is optional. If you want to extract the second staff completely, you have to pass |2|. Multiple combinations are possible, e.g. |2.2.|4.1|5|. If all parts contained in the score are requested, e. g. |1|2|3|4| for a string quartet, the file will be just copied.</p>
      <pre> </pre>
