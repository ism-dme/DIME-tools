...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
   ...
   <pattern id="annotation_1"
            ...
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/annotation.html">
      ...
      <param name="phase"
             value="refTexts_v3, altTexts_v3, refTexts_v4, altTexts_v4, refTexts_v5"/>
      <param name="message"
   ...
   <pattern id="chord_1"
            ...
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/chord.html">
   ...
   <pattern id="clef_1"
            ...
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/clef.html">
   ...
   <pattern id="corr_1"
            is-a="matchesAttributeValue"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/corr.html">
   ...
   <pattern id="facsimile_1"
            is-a="matchesAttributeValue"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/facsimile.html">
      <param name="element" value="mei:facsimile"/>
      <param name="attribute" value="decls"/>
      <param name="RegEx" value="#digital_image[\d]?"/>
      <param name="phase" value="refTexts_v3, refTexts_v4, refTexts_v5"/>
   </pattern>
   <!--Generated from topics/hairpin.dita.-->
   <pattern id="hairpin_1"
            is-a="matchesAttributeValue"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/hairpin.html">
   ...
   <pattern id="identifier_1"
            is-a="containsAttributes"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/identifier.html">
      <param name="element" value="mei:work/mei:identifier[not(@sameas)]"/>
      <param name="attributes" value="auth"/>
      <param name="phase" value="refTexts_v4, refTexts_v5"/>
   </pattern>
   <!--Generated from topics/identifier.dita.-->
   ...
   <pattern id="mrest_1"
            is-a="checkAttributeValue"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/mrest.html">
   ...
   <!--Generated from topics/scoreDef.dita.-->
   <pattern id="scoreDef_1"
            is-a="matchesAttributeValue"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/scoreDef.html">
      <param name="element" value="mei:scoreDef"/>
      <param name="attribute" value="optimize"/>
      <param name="RegEx" value="true|false"/>
      <param name="phase"
             value="refTexts_v3, altTexts_v3, refTexts_v4, altTexts_v4, refTexts_v5"/>
   </pattern>
   ...
   <pattern id="supplied_1"
            is-a="matchesAttributeValue"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/supplied.html">
      <param name="element" value="mei:supplied"/>
      <param name="attribute" value="resp"/>
      <param name="RegEx" value="(#NMA-editors)|(#DME-editors)"/>
      <param name="phase"
             value="refTexts_v3, refTexts_v4, altTexts_v3, altTexts_v4, refTexts_v5"/>
   </pattern>
   <!--Generated from topics/tempo.dita.-->
   <pattern id="tempo_1"
            is-a="matchesAttributeValue_optionalAttribute"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/tempo.html">
   ...
   <pattern id="tuplet_1"
            is-a="matchesAttributeValue_optionalAttribute"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/tuplet.html">
   ...
   <pattern id="unclear_1"
            is-a="checkAttributeValue"
            see="file:///K:/PROJEKTE/DIME/4_Arbeitsmittel/DIME-Tools/docs/schematron/webhelp-responsive/topics/unclear.html">
